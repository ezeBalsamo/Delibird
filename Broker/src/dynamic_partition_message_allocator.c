...
t_block_information*  find_block_to_allocate_message(t_list* blocks_information){
...
void dynamic_partition_allocate_message(t_identified_message* message,t_list* blocks_information){
    ...
    t_block_information* block_information_found = find_block_to_allocate_message(blocks_information);

    //encontre un block manager disponible
    //lo spliteo y creo uno nuevo que tenga la memoria restante, que este libre
